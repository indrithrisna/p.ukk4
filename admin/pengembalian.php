...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-2 sidebar p-0">
            ...
            <a href="alat.php"><i class="bi bi-box"></i> Kelola Alat</a>
            <a href="kategori.php"><i class="bi bi-tags"></i> Kategori</a>
            <a href="peminjaman.php"><i class="bi bi-clipboard-check"></i> Peminjaman</a>
            <a href="pemantau_pengembalian.php"><i class="bi bi-arrow-return-left"></i> Pemantau Pengembalian</a>
            <a href="pengaturan_denda.php"><i class="bi bi-cash-coin"></i> Pengaturan Denda</a>

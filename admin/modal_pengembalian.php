<!-- Modal Pengembalian untuk ID: <?php echo $row['id']; ?> -->
            ...
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm">
                        ...
                        ?>
                        <tr>
                            <td width="60%">Denda Keterlambatan (<?php echo $hari_terlambat; ?> hari x Rp <?php echo number_format($pengaturan['denda_per_hari'], 0, ',', '.'); ?>)</td>
                            <td class="text-end">
